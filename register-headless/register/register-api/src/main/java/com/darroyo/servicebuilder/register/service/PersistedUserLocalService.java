...
/**
 * Provides the local service interface for PersistedUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PersistedUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PersistedUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.darroyo.servicebuilder.register.service.impl.PersistedUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the persisted user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PersistedUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PersistedUser getPersistedUser(String userId) throws PortalException;
